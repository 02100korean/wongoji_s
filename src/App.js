...
// --- [2. 홈 화면: v.12 완벽 보존] --- [cite: 306-322]
  ...
  return (
    <div className="app-root-container">
      <style>{`
        ...
        /* [인쇄 설정: 6종 독립 케이스 완벽 반영 및 부모 레이아웃 전면 개편] */
        @media print {
