    ...
    <div className="app-root-container">
      <style>{`
        ...
        @media screen and (orientation: portrait) {
          ...
          .main-preview { width: 100% !important; height: 50% !important; flex-basis: 50% !important; padding: 10px !important; align-items: flex-start !important; }
                ...
                <div className="manuscript-print-root">
                  {Array.from({ length: pageCount }).map((_, p) => (
                    <div key={p} className="page-unit">
                      <div style={{ backgroundColor: 'white', padding: '40px 60px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', marginBottom: '0', width: 'max-content' }} className="page-box">
